...
class SetParameters:
    def get_params(self):
        def save_parameters():
            ...
            self.desc_path = img_desc_path_box.get()
            self.video_path = vid_path_box.get()
            self.video_desc_path = vid_desc_path_box.get()
        ...
        field_labels = ["Image Location", "Image Description Location", "Participant Initials", "Nonsense File Path",
                        "Video Location", "Video Description Location"]

        img_path_box = ttk.StringVar()
        img_desc_path_box = ttk.StringVar()
        res_path_box = ttk.StringVar()
        nonsense_path_box = ttk.StringVar()
        vid_path_box = ttk.StringVar()
        vid_desc_path_box = ttk.StringVar()
        ...
        desc_entry = tkinter.Entry(frame, textvariable=img_desc_path_box)
        ...
        nonsense_entry = tkinter.Entry(frame, textvariable=vid_path_box)
        nonsense_entry.insert(0, 'assets/BenchmarkVIDEO')
        nonsense_entry.grid(row=4, column=1, sticky='W')

        tkinter.Label(frame, text=field_labels[5]).grid(row=5, column=0, sticky='E')
        nonsense_entry = tkinter.Entry(frame, textvariable=vid_desc_path_box)
        nonsense_entry.insert(0, 'assets/video_descriptions.csv')
        nonsense_entry.grid(row=5, column=1, sticky='W')
    ...
    def __init__(self):
        ...
        self.img_desc_path = 'assets/descriptions.csv'
        self.res_path = 'noname'
        self.video_path = 'assets/BenchmarkVIDEO'
        self.video_desc_path = 'assets/video_descriptions.csv'
        self.get_params()
